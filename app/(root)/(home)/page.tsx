...
import NewSession from "@/app/(auth)/new-session/page";
import Community from "@/components/community/page";

const Home = () => {
  //member -> community -> sessions -> cards go in here, needs a checker to display community's that are within membership
...
//     <>
//       {!sessionId ? (
//         <NewSession onSignUp={handleSessionIn} />
//       ) : userId && sessionId ? (
